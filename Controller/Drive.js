...
const registerDriver = async (req, res) => {
  try {
    ...
    // Exact standard values extracted:
    const finalCountryCode = parsedPhone.countryCode; // Output: "+92"
    const finalPhoneNumber = parsedPhone.formattedLocal; // Output: "3117586447"
    const finalCountryIso = parsedPhone.countryIso; // Output: "PK"
